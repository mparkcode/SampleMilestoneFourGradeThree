    ...
    for base_url in base_urls:
        ...
        while url:
            ...
            for product in soup.find_all('div', class_="entry-product"):
                ...
                try:
                #    print(product)
                    picture_link = product.find(
                        'div', class_="entry-featured").a.img['data-lazy-src']
                    # print(picture_link)
                    ...
                    s3.Bucket('samplemilestonefour-gradefour').put_object(Key="media/images/" + picture_name, Body=r2.content)
                    ...
                    title = product.find(
                        'div', class_="entry-wrap").header.h3.a.text
                    price = product.find(
                        'div', class_="entry-wrap").header.span.span.text
                    price = float(price[1:])
                    brand = Brand.objects.get(name=brand)
